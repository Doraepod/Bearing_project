...
#define I2C_DDR		PORTC_DIR	// Порт на котором реализуется I2C
#define I2C_PORT	PORTC_OUT	// Порт на котором реализуется I2C
#define I2C_PIN		PORTC_IN	// Порт на котором реализуется I2C

#define I2C_SCL		1	// Пин SCL
#define I2C_SDA		0	// Пин SDA
